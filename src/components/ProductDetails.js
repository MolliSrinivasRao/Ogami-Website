        ...
        <div>
            ...
            <div className="productDetails-container" >
                ...
                {pDetails?.discount&&(
                    ...
                    <div className="price" >
                        $6.99 <AiFillStar className="starr" /><AiFillStar className="starr" /><AiFillStar className="starr" /><AiFillStar className="starr" /><AiFillStar className="starr" />
                    </div>
            ...
            <div className="downbar" >
                {tab == 0 && <div><p className="paradesp" >Last but not least, we couldn't write a post on blogs to follow on sustainable living without mentioning our very own blog, The Organic society. Our mission is to inspire families to eat well, do good and live better. Our blog covers all things organic, from food to farming, health and wellness to fashion and beauty.</p></div>}
                {tab == 1 &&
                                ...
                                return (
                                    ...
                                    <div className="reviewcontainer">
                                        <div className="reviewsubdiv">
                                            ...
                                            <span>
                                                <AiFillStar className="starrr" />
                                                <AiFillStar className="starr" />
                                                <AiFillStar className="starr" />
                                                <AiFillStar className="starr" />
                                                <AiFillStar className="starrr" />
                                            </span>
